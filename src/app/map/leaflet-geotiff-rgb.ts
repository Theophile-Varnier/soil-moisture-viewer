...
export const LeafletGeotiffRenderer = L.Class.extend({
  ...
  render(raster: any, canvas: any, ctx: any, args: any) {
    throw new Error('Abstract class');
  },
});

export const LeafletGeotiffRGB = LeafletGeotiffRenderer.extend({
  options: {
    cutoffBrightest: 0,
  },
